...
class DataValidationAgent(BaseMicroAgent):
    ...
    RUBRIC = (
        ...
        "Band 5: Strong rules + drift monitors + CI gates with alerts;\n"
        "Band 4: Solid schema/range checks; partial CI wiring;\n"
        "Band 3: Some checks but no enforcement or drift;\n"
        "Band 2: Ad-hoc validations only;\n"
        "Band 1: No validation or insufficient evidence."
    )
    INPUT_MEANINGS = {"code_snippets[]": "Pipelines validating data schemas/distributions/drift."}
